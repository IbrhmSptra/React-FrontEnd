...
const Banner = (props) => {
    ...
    return(
        <div className={`${position} w-[50%] h-full hidden md:absolute md:flex transition-all duration-500`}>
            <Background className="flex-col h-full w-full justify-center gap-y-48 items-center md:flex hidden">               
                ...
                <ChangeAuth onClick={() => setSlide(!slide)} quetion={quetion} info={info} className='flex-col'/>
            </Background>
        </div>
    )
}
